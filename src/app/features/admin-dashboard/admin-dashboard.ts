    ...
    <div class="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header class="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <span class="text-xs font-medium px-2 py-0.5 rounded-full"
            [class]="authService.currentUser()?.role === 'admin' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700'">
      ...
      <div class="flex flex-1">
        ...
        <aside class="w-56 bg-white border-r border-gray-200 p-4 space-y-1">
          ...
          <a routerLink="members" routerLinkActive="bg-blue-50 text-blue-900 font-semibold"
            class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition-colors">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="accounts" routerLinkActive="bg-blue-50 text-blue-900 font-semibold"
            class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition-colors">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <a routerLink="beneficiaries" routerLinkActive="bg-blue-50 text-blue-900 font-semibold"
            class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition-colors">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          @if (authService.currentUser()?.role === 'admin') {
            <a routerLink="staff" routerLinkActive="bg-blue-50 text-blue-900 font-semibold"
              class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition-colors">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
